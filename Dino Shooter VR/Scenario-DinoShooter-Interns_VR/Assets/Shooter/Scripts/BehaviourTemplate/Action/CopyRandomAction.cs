...
{
    public class CopyRandomAction : BasicAction
    {
        ...
        public override void Execute()
        {
            ...
            var go = GameObject.Instantiate(actor, new Vector3(rx, ry, rz), actor.transform.rotation);
            go.SetActive(true);
            _done = true;
        }
        ...
        {
            if (conditionAction is CopyRandomAction)
            {
                var ca = conditionAction as CopyRandomAction;
        ...
        {
            get { return "Copy to Random Postion"; }
        }
    }
}